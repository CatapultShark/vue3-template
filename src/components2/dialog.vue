...
import { FIELD_MAP } from '@/constant/common-constants';

const target = inject('target') as LogicFlow;
...
const type = target.value.properties.type as keyof typeof FIELD_MAP;
console.log(type, 'type', FIELD_MAP);
const attributeList = reactive(FIELD_MAP[type]) || [];
